...
Widget placeHolderRemisWidget(
    {double? height,
    double? width,
    BoxFit? fit,
    AlignmentGeometry? alignment,
    double? radius}) {
  return Image.asset('images/placeholder_remis.png',
      height: height,
      width: width,
      fit: fit ?? BoxFit.cover,
      alignment: alignment ?? Alignment.center);
...
String printDistanceUnit(String amount) {
  return appStore.currencyPosition == LEFT ? '$amount Km' : 'Km $amount';
}
