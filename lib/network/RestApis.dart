...
import 'package:taxi_booking/model/AdditionalFeesList.dart';
...
Future updateProfile(
  ...
  multiPartRequest.fields['dni_number'] = sharedPref.getString(DNI).validate();
  ...
  await sendMultiPartRequest(multiPartRequest, onSuccess: (data) async {
    if (data != null) {
      ...
      await sharedPref.setString(DNI, res.data!.dni_number.validate());
