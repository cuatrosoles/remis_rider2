      ...
      if (permission != LocationPermission.denied) {
        try {
          if (mounted) {
            ...
            print('DATAGEO1 CURRENT_LOCATION: ' + currentLocation.toString());
            ...
            print('DATAGEO2 SOURCE_LOCATION: ' + sourceLocation.toString());
          ...
          print('DATAGEO ERROR DASHBOARD: ' + e.toString());
        }
        ;
      } else {
        if (mounted) {
