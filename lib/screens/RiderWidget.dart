                        ...
                        onTap: () async {
                          await searchAddressRequestPlaceId(
                            ...
                            if (sourceFocus.hasFocus) {
                              ...
                              print('source1 :' + sourceLocation.text);
                              ...
                              if (sourceLocation.text.isNotEmpty &&
                                ...
                                launchScreen(
                                    ...
                                    NewEstimateRideListWidget(
                                        ...
                                        /// ERROR NO TOMA VALOR SOURCE LOCATION
                              ...
                              polylineDestination = LatLng(
                                  data.location!.lat!, data.location!.lng!);
                              print(
                                  'destination1 :' + destinationLocation.text);
                              if (sourceLocation.text.isNotEmpty &&
                                  destinationLocation.text.isNotEmpty) {
                                launchScreen(
                                    context,
