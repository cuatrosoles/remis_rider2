...
mixin _$AppStore on _AppStore, Store {
  ...
  */
  ...
  late final _$dni_numberAtom =
      Atom(name: '_AppStore.dni_number', context: context);

  @override
  String get dni_number {
    _$dni_numberAtom.reportRead();
    return super.dni_number;
  }

  @override
  set dni_number(String value) {
    _$dni_numberAtom.reportWrite(value, super.dni_number, () {
      super.dni_number = value;
    });
  }
  ...
  */
  ...
  late final _$setdni_numberAsyncAction =
      AsyncAction('_AppStore.setdni_number', context: context);

  @override
  Future<void> setdni_number(String val, {bool isInitialization = false}) {
    return _$setdni_numberAsyncAction.run(
        () => super.setdni_number(val, isInitialization: isInitialization));
  }
